...
I replicated TRNG pipeline in a tool into a working state. Including deterministic model of entropy-source itself, with purposedly limited precision. Contributions are welcome to make replicas more precise.
