...
> Trying to parse this README with AI naively is likely a bad idea (they often complain that notebooks are html - they html bcause you can simply use them to test cryptogrpahic models, Jupyter ietc is slow and cumbersone, SageMath is overdesigned, js is light). You can try to use something STEM, like GPT-OSS or cross-reference with chats. But ideally, don't use AI - just run HTML files and see what they do.
-----
