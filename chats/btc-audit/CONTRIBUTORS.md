...
- comment on donation #2: founder is learning to not use Ledger Live, but Electrum (with Ledger plugin) instead to keep some pledge in the fund.
  ...
  - early-investment is stronger guarantee than pledge, since it protects the fund from founder himself inflating his profit-share (by pretending to be an investor and re-investing same amounts over and over), especially if done by major investors and groups.
