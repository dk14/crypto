...
- important note: keep in mind, I'm aware that exaustive universal search is the most efficient way to produce generators of high-entropy numbers and aware of serious drawbacks of originally published one, and current present-day challenges related to optimality (this is what I'm researching myself in background). The full solution still requires a network maintained by humans to be practical though, thus the advertisement campaign for replicas, they are first practical step.