...
>>> *Overall, there are enough specs in this repo for AI game masters to build first PoC approximation of Explorer Network together with players, alongside with investement into real product (-lg address), allowing players to profit IRL as compensation for their IRL coding, operational and advertisement efforts*
