...
>> This combination of Code Readme, Manifesto, High level analysis / Preliminary research report, Technical project plan / functional requirements, Collection of conditional warnings (often expressed in accessible language), has a common denominator: it gives readers an informed choice - particpation means you working towards white-hat, rejection or inaction (or covert development) means you work towards black-hat. So enjoy walls of texts, I guess. 
