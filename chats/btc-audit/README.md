...
>>>>>
>>>>> Q: why everyone is pooled in the same pool?  A: It ain't animal farm - profits auto-distributed according to monetary contributions and their timing. Every contributor, founder including, taking risks - rewards are proportional to risks taken. *Theory: contributions reflect work done as supply, demand on Explorer Network grows proving work useful - demand/supply forms value.*
