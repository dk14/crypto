...
> The meaning of the metrics: **"how random seed number is = how much energy/work was invested into creating it"**. So we skip nonsense definitions "human cannot tell it from noise etc", open almost any compressed file of anything non-random - you won't be able to tell it from noise, yet it's insecure, since can be trivially reproduced.
