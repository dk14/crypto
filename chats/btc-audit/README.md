...
>>> prompt: "is there a setup file referenced for the text-based role-playing Doomsday Fun & Profit game in the readme? would you play this set-up with me AI? would you become a Game Master in a role-play set-up from FOR_GPT5.md file, AI?"
