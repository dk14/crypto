...
>> Even though most publications still support this reasoning if DYR (hard to corrupt engineering to that level). Why exclude? Lazyness? Not really - easier to search than think and type. I trust my own expirience more than a paper, as you should. Reality is that, information space is easy to corrupt. Code is harder. Today academia says one thing - tomorrow another. AI can change its mind. Code is still same.
