...
> I won't add anything more novel or stable features to this repo until there are funds. Incl. funds conpensating for work done already.
...
> This project is about securing ALL your, human (kid or adult - no matter), funds (not only crypto, even in bank, even cash/gold, social bonds even). If you cannot invest right now - you gotta promote ASAP. EVERYTHING RUNS ON TRNGs! BTC has best chance of surviving the imminent attack - tha's why we focus on it first.
