...
> For devs: Trivial psychology allowed me to discover the issue, but risks are not trivial. So either, this will be the project where eventually Ledger Wallet team will submit their replicas officially (after audits), or everyone will lose their funds. So, let's say DeutscheBank's "professionals", can skip this README, just invest into your survival here, don't work against yourselves, you'll get your cut for what it worth, just stop pretending you're engineers. I'm still me, FED.
