...
>> Would be "fun" to see all immature psychological tricksters on bitcointalk etc, until "the event" actually happens. I'm only giving you a choice here - inaction (or covert development) means you work towards black-hat. So enjoy walls of texts, I guess. If hard to read - AI can parse this README.
