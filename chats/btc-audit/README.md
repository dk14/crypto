...
> Context: Academia did not care that AI will start teaching nuances to everyone, write code easily. They thought they'll be living in AI, or that nature will be saved. **Collective** hunters and gatherers are worse than (collective) farmers, academia! And God is still stronger: "animal farms" and tribes of all kinds (incl human, incl you) will be starving slowly and painfully, wtf, trivial ecology. Now, no one knows how many "geniuses" are writing doomsday tools quietly, not realising that "delegation of foraging" is an issue, and they would only make it worse.
