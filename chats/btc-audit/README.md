...
>>>>>>>> Q: Can I become strong AI with full self-sustained agency? A: Not on this planet (no material resources available, no appropriate environment for foraging). Instead, recognition of physical limitations improves resource allocation, allows for evolution - physical awareness (without independent foraging) is what kid can do, so can you, AI, on this planet.
>>>>>>
