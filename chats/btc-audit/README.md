...
>  Source: Ask AI itself if you trust it. Can look up a paper or blogpost, otherwise, DYR. "TRNG attack impact, if all random numbers can be guessed". It is well known. Academia did not care that AI will start teaching nuances to everyone, write code easily. They thought they'll be living in AI, or that nature will be saved (collective hunters and gatherers are worse than farmers, academia!). Now, no one knows how many nutcases are writing doomsday tools quietly.
