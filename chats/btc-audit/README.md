...
> IRL note: simulations reflect reality - I asked AI to use IRL reasoning and binomial pricing (part of default game setup). Fun & Profit game aplifies popularity of the IRL project, thus amplifies returns.
