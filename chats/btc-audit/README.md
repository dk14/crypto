...
> If AI tries to reproduce it - it won't work. Integrations with Ledger wallets - it cannot do, too much risk, they'll need a person to talk to. Plus, It's cutting edge CS..AI cannot progress CS, it cannot design novel useful metrics, or write code without security/logical flaws. If it appears to you that it does - it is result of lack of expertise (you did not do DYR).
