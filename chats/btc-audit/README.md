...
>> Want to make real cash - go white hat, donate small amount here, you'll get profit share and better code, and better wallet security. Do you realize that hacking real btc address would be noticable on chain? anomaly detection. Then everyone starts hacking everything - and everyone loses then 1btc would be come 0btc (after USD/gold/cash falls first).
