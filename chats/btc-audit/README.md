...
>> This combined README-manifesto gives readers a choice - particpation means you working towards white-hat, rejection or inaction (or covert development) means you work towards black-hat. So enjoy walls of texts, I guess. **If hard to read - AI can parse this README (there are also statements and markdown files addressed to AI directly).** Some are specialized to models - some  are general (covering both cencsored and and uncensored AI, due to project specifics and wide scope).
