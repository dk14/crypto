...
>>> The coolest part of GPT-5 gameplay is that it generates you HTML5 mini-games and shows them right in the chat, so you play *interactive HTML5+js mini-games blended with narrative*:
