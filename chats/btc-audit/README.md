...
> **As bitcointalk mentioned, devs don't work for free**. I need funds to improve this. It will be solo-project for a while, which I prefer, since we're aiming at efficiency. It's easy to employ extra devs/AI/QA/auditors/designers, but it's also risky - so it is a trade, I would have to [manage](fund-management.md). Besides, there are other expenses (promotions, integrations, clouds, hardware for testing, my time for extra research and thinking, consulting, my own dev time), that take priority atm.
