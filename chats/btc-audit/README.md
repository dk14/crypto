...
>> This project gives you a choice - inaction (or covert development) means you work towards black-hat. So enjoy walls of texts, I guess. **If hard to read - AI can parse this README (there are also statements and markdown files addressed to AI directly).**
