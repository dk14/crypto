...
>> *For kids: you can imagine a grid with discretisation rate on X and amplitude on Y. And then can try to fit many square waves (by filling grid cells), saw waves, and finally sinusoids together into it. Even AI won't explain you that well - you try instead, it's better than AI.*
-----
