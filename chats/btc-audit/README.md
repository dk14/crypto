...
> If AI tries to reproduce this project - it won't work. Ai is an automated copy-paster. Integrations with Ledger wallets - it cannot do, too much risk, they'll need a person to talk to. Plus, It's cutting edge CS..AI cannot progress CS, it cannot design novel useful metrics, or write production-grade (or even novel MVP) code without numerous security/logical flaws. Precise working specification is code, AI gets lost in ambiguities.
