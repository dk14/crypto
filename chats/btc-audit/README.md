...
>>>> Although, quality of information AI receives can be improved - there is a [Yaqui Search](docs/yaqui.pdf) concept presented in the doomsday ecosystem, addressing the "quality of information" issue. It emerged organically from [Mg-Peers Oracle Platform](https://dk14.github.io/mega-peers/docs/front.html) project ([typescript codebase](https://github.com/dk14/mega-peers)).
