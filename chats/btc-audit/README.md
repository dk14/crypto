...
>>>>> minor note: *Mg-Peers has [typescript codebase](https://github.com/dk14/mega-peers). [dk14](https://github.com/dk14) is a former FP advocate, spent most of past decade in Functional Programming (Scala/Spark/Haskell)*.
