...
>  Source: Ask AI itself if you trust it. Can look up a paper or blogpost, otherwise, DYR. "TRNG attack impact, if all random numbers can be guessed". It is well known. I only made AI admit that not only human, but even (low-powered) hardware is a bad source of randomness. [Context](drama-context.md)
